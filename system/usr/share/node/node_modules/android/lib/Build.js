...
class Build {
  ...
  static LOCKED = SystemProperties.get("ro.boot.flash.locked") === "0";
  ...
  */
  static VERSION = class {
    ...
    static SDK = SystemProperties.getInt("ro.build.version.sdk", 0);
    ...
    static MIN_SUPPORTED_TARGET_SDK_INT = SystemProperties.getInt("ro.build.version.min_supported_target_sdk", 0);
    static require(version) {
      if (typeof version != "number") {
          throw new TypeError("The version should be an string")
      }
  ...
  static HW_TIMEOUT_MULTIPLIER = SystemProperties.getInt("ro.hw_timeout_multiplier", 1);
  static IS_TREBLE_ENABLED = SystemProperties.getBoolean("ro.treble.enabled", false);
  static TIME = SystemProperties.getInt("ro.build.date.utc") * 1000;
  static USER = SystemProperties.get("ro.build.user");
  static HOST = SystemProperties.get("ro.build.host");
  static IS_DEBUGGABLE = SystemProperties.getInt("ro.debuggable", 0) == 1;
